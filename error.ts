...
/**
 * This class provides a wrapper for network errors when making requests to Klarna Payments API V1
 */
export class KlarnaPaymentsError extends Error {
  /**
   * The response body
   */
