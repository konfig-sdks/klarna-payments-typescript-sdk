...
export interface SessionCreate {
     ...
     */
    'acquiring_channel'?: SessionCreateAcquiringChannelEnum;
    /**
     * 
     * @type {Attachment}
     * @memberof SessionCreate
     ...
     * @memberof SessionCreate
     */
    'status'?: SessionCreateStatusEnum;
    /**
...
type SessionCreateAcquiringChannelEnum = 'ECOMMERCE' | 'IN_STORE' | 'TELESALES'
type SessionCreateStatusEnum = 'complete' | 'incomplete'
type SessionCreateIntentEnum = 'buy' | 'tokenize' | 'buy_and_tokenize'
