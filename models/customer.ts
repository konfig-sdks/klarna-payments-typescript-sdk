...
export interface Customer {
     ...
     * @memberof Customer
     */
    'organization_entity_type'?: CustomerOrganizationEntityTypeEnum;
    /**
...
type CustomerOrganizationEntityTypeEnum = 'LIMITED_COMPANY' | 'PUBLIC_LIMITED_COMPANY' | 'ENTREPRENEURIAL_COMPANY' | 'LIMITED_PARTNERSHIP_LIMITED_COMPANY' | 'LIMITED_PARTNERSHIP' | 'GENERAL_PARTNERSHIP' | 'REGISTERED_SOLE_TRADER' | 'SOLE_TRADER' | 'CIVIL_LAW_PARTNERSHIP' | 'PUBLIC_INSTITUTION' | 'OTHER'
