...
import { CustomerRead } from './customer-read';
...
export interface SessionRead {
     ...
     * @type {string}
     * @memberof SessionRead
     */
    'acquiring_channel'?: SessionReadAcquiringChannelEnum;
    /**
     * 
     * @type {Attachment}
     * @memberof SessionRead
...
type SessionReadAcquiringChannelEnum = 'ECOMMERCE' | 'IN_STORE' | 'TELESALES'
type SessionReadStatusEnum = 'complete' | 'incomplete'
type SessionReadIntentEnum = 'buy' | 'tokenize' | 'buy_and_tokenize'
